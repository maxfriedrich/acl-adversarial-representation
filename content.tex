...
%
We compare three different approaches: a none-private de-identifiation classifier and two privacy-enabled extensions, automatic pseudonymization (\cref{sec:automatic-pseudonymization}) and adversarially learned representations (\cref{sec:adversarial-representation}).
...
and represents a 20\% relative error reduction to the automatic pseudomization approach.
% TODO: Maybe call the raw data baseline something different than baseline.  Baseline == lower bound, but for us it is more like the upper bound.
% "raw data system"?
% TODO: this 20% relative error reduction is computed against automatic pseudomization with N=100. We should probably compare it to N=500 as this is the upper bound for which the approach is stable.
% Current computation: (97.4-96.75)/(100-96.75)*100
% I don't have the number for N=500.
%
