...
\begin{table}
    ...
    \begin{tabular}{ll}
        ...
        \bottomrule
    \end{tabular}
    \caption{Binary \ac{hipaa} \fone scores of our non-private de-identification models on the i2b2 2014 test set in comparison to the state of the art.}\label{tab:baseline-results}
\end{table}
