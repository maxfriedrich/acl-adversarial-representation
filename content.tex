...
\begin{figure*}
    ...
    \caption{Sharing training data for de-identification.
        ...
        %
        Manual pseudonymization is additionally marked with a dollar icon to emphasize its high costs.
    }\label{fig:process}
\end{figure*}
...
%
Automatic de-identification labeling can however significantly speed up the process, as shown for other annotation tasks in e.g. \citet{yimam2015todo}\todo{Yimam}.
