...
%
Automatic de-identification labeling can however significantly speed up the process, as shown for other annotation tasks in e.g. \citet{yimam2014automatic}.
