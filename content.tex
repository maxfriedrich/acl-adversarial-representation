...
\section{Dataset and Experimental Approach}

To evaluate our approaches, we perform experiments using the i2b2 2014 dataset~\citep{stubbs2015annotating} which was released as part of
