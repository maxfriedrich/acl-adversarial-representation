...
% TODO (Arne): Auch sagen, dass man dann die Repräsentationen teilen kann um Datenpooling zum Training zu nutzen.  Mit publicly available wäre ich etwas vorsichtig, da ja auch die pseudonymisierten Daten auf denen das System jetzt trainiert wurde aus guten Gründen nicht frei verfügbar sind.
...
% TODO (Arne): Vielleicht als Definition mit Namen einführen und dann dahin referenzieren statt zu wiederholen?
%
...
% TODO (Arne): Vielleicht zuerst erklären welche Angriffe man verhindern will und auf der Basis die Adversaries einführen statt umgekehrt?  Wenn man denen dann einen Namen gibt, kann man später besser darauf verweisen.
...
\begin{figure*}
    ...
    % TODO (Arne): Kästen rechteckiger machen um Höhe zu sparen
\end{figure*}
...
\begin{description}
    ...
    % TODO maybe delete this paragraph and the learning curves figure?
    %
