...
% Bib (for Max autocompletion, can be deleted later)
\usepackage{natbib}
...
% Description format
\usepackage{enumitem}
\setlist[description]{leftmargin=0cm} %TODO is this allowed?
...
% TODO title should probably say that it's a ``private representation''
