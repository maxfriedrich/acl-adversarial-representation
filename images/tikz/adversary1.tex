%TeX root=adversary2-standalone
...
\path (feature box) -- (feature2 box) node[model, midway,above=3.7cm] (adversary model) {Adversary Model};
...
\path[post] (feature2 box) edge (adversary model);
