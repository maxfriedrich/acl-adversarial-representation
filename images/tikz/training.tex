\begin{tikzpicture}[node distance=1.5cm,font=\small, sibling distance=6.5mm, level distance=1cm, grow=up, edge from parent/.style = {->, >=latex, draw}]
\tikzset{every node/.style={inner sep=0mm, outer sep=0mm, line width=0mm}}

\tikzstyle{model}=[rounded rectangle,draw=black,fill=white, minimum width=5.5mm, minimum height=3mm, semithick]
