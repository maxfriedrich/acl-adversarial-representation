...
\node[quarter vector, above right=2.5cm and 0cm of was representation] (adversary output) {};
...
\node[anchor=east, left=2mm of input box] {Tokens};
\node[anchor=east, left=2mm of feature box] {Emb.};
\node[anchor=east, left=2mm of representation box] {Represent.};
\node[anchor=center, above=2mm of output box] {De-identification output};
\node[anchor=center, above=2mm of adversary output box] {Adversary output};
