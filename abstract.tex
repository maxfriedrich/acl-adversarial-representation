...
%
It is a critical step in preparing \acp{ehr} to be shared for research.
%
...
%
A widely available de-identification classifier could potentially enable medical studies for which de-identification would otherwise be too costly.
\end{abstract}
